...
$H_0$: The vaccine (covid921) IS  effective in females

## Methods

Variable "Females" is categorical

Variable "Treatment" categorical 
...
The graph shows that more women who took the placebo got covid than women who tool the vaccine. 
...
In conclusion we must REJCT Ho this is because the p-value is less that 0.05 and the odds ratio is shown to be effective ( 1.86|1 )
